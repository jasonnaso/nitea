                    ...
                    // list of posts
                       ...
                       <div <?php post_class(); ?>>
                            ...
                            <h1 class="page-header">
                                <a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'devdmbootstrap3' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php get_template_part('partials/custom-title'); ?></a>
                            </h1>
